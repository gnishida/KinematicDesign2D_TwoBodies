...
public:
    ...
    void setupUi(QDialog *LinkageSynthesisOptionDialog)
    {
        ...
        LinkageSynthesisOptionDialog->resize(352, 572);
        ...
        label_18 = new QLabel(LinkageSynthesisOptionDialog);
    ...
    void retranslateUi(QDialog *LinkageSynthesisOptionDialog)
    {
        ...
        checkBoxAvoidBranchDefect->setText(QApplication::translate("LinkageSynthesisOptionDialog", "Avoid branch defect/poor transmission angle defect", 0));
